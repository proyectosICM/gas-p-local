...
class DeviceAdapter(private val context: Context, private val devices: List<DeviceModelData>) : RecyclerView.Adapter<DeviceAdapter.DeviceViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DeviceViewHolder, position: Int) {
        ...
        holder.btnAction.setOnClickListener{
            ...
            Log.d("Activado", "Clicked on ${device.name}")
            sendMessageToWebSocket("${device.name}:Activating")
        }
    }
